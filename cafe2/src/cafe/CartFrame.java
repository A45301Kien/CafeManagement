...
public class CartFrame extends javax.swing.JFrame {
    ...
    private void init() {
        ...
        jTextField2.setText(curentDate.format(formatter));
        ...
        if (check()) {
            if (dao.insertPayment(payment)) {
                ...
                if (x == JOptionPane.YES_OPTION) {
                    try {
                        MessageFormat header = new MessageFormat("Customer Name:"+ cName+ "|"+ "Total:"+ t+"'d(included tax)'");
    ...
    public boolean check() {
        if (jTextField4.getText().isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, "Cart is required", "Warning", 2);
            return false;
        }
